...
import com.example.minorproject.async.DecodeTask;
import com.example.minorproject.async.EncodeTask;
import com.example.minorproject.async.SteganographyParams;
...
public class MainActivity extends AppCompatActivity implements AsyncResponse<SteganographyParams> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        encodeButton.setOnClickListener(v -> startCameraGalleryChooser());

        Button decodeButton = (Button) findViewById(R.id.button_decode);
        decodeButton.setOnClickListener(v -> pickImage(PICK_IMAGE_DECODE));

        Button sendButton = (Button) findViewById(R.id.button_send);
        sendButton.setOnClickListener(v -> pickImage(PICK_IMAGE_SEND));
